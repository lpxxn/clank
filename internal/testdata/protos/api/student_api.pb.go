...
var file_protos_api_student_api_proto_rawDesc = []byte{
	...
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x32, 0xbc, 0x02, 0x0a, 0x0a, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e,
	...
	0x01, 0x30, 0x01, 0x12, 0x3f, 0x0a, 0x0d, 0x51, 0x75, 0x65, 0x72, 0x79, 0x53, 0x74, 0x75, 0x64,
	0x65, 0x6e, 0x74, 0x73, 0x12, 0x11, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x1a, 0x19, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x53, 0x74, 0x75, 0x64, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x30, 0x01, 0x42, 0x44, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x61, 0x70, 0x69, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x6c, 0x70, 0x78, 0x78, 0x6e, 0x2f, 0x63, 0x6c, 0x61, 0x6e, 0x6b, 0x2f, 0x69, 0x6e,
...
var file_protos_api_student_api_proto_depIdxs = []int32{
	...
	0, // 5: api.StudentSrv.QueryStudents:input_type -> api.QueryStudent
	4, // 6: api.StudentSrv.NewStudent:output_type -> protos.Result
	1, // 7: api.StudentSrv.StudentByID:output_type -> api.QueryStudentResponse
	1, // 8: api.StudentSrv.AllStudent:output_type -> api.QueryStudentResponse
	1, // 9: api.StudentSrv.StudentInfo:output_type -> api.QueryStudentResponse
	1, // 10: api.StudentSrv.QueryStudents:output_type -> api.QueryStudentResponse
...
type StudentSrvClient interface {
	...
	QueryStudents(ctx context.Context, in *QueryStudent, opts ...grpc.CallOption) (StudentSrv_QueryStudentsClient, error)
}
...
func (c *studentSrvClient) QueryStudents(ctx context.Context, in *QueryStudent, opts ...grpc.CallOption) (StudentSrv_QueryStudentsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StudentSrv_serviceDesc.Streams[2], "/api.StudentSrv/QueryStudents", opts...)
	if err != nil {
		return nil, err
	}
	x := &studentSrvQueryStudentsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type StudentSrv_QueryStudentsClient interface {
	Recv() (*QueryStudentResponse, error)
	grpc.ClientStream
}

type studentSrvQueryStudentsClient struct {
	grpc.ClientStream
}

func (x *studentSrvQueryStudentsClient) Recv() (*QueryStudentResponse, error) {
	m := new(QueryStudentResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StudentSrvServer interface {
	...
	QueryStudents(*QueryStudent, StudentSrv_QueryStudentsServer) error
}
...
func (*UnimplementedStudentSrvServer) QueryStudents(*QueryStudent, StudentSrv_QueryStudentsServer) error {
	return status.Errorf(codes.Unimplemented, "method QueryStudents not implemented")
}
...
func _StudentSrv_QueryStudents_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(QueryStudent)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(StudentSrvServer).QueryStudents(m, &studentSrvQueryStudentsServer{stream})
}

type StudentSrv_QueryStudentsServer interface {
	Send(*QueryStudentResponse) error
	grpc.ServerStream
}

type studentSrvQueryStudentsServer struct {
	grpc.ServerStream
}

func (x *studentSrvQueryStudentsServer) Send(m *QueryStudentResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _StudentSrv_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "QueryStudents",
			Handler:       _StudentSrv_QueryStudents_Handler,
			ServerStreams: true,
		},
	},
